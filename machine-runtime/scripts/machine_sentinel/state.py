    ...
    *,
    ...
    return {
        ...
        "process": {
            ...
            "lastOwnedProcessIdentity": None,
            "recoveryOutstanding": False,
            "lossObservedAt": None,
            "recoveryEpisode": None,
            "unresolvedRecoveryEpisodes": [],
            "lastVerifiedIdentityAt": None,
            "lastIdentityReplacement": None,
            "protectedIdentity": None,
            "identityDiscrepancy": None,
            "bootId": boot_id,
        },
        "commands": {},
        "commandOrder": [],
        ...
        "eventSpoolFailures": [],
        "localEventOutbox": [],
        "nextLocalEventSequence": 1,
        "runBindingGap": None,
        "logObservationSession": None,
        "logCheckpoints": {},
    }
